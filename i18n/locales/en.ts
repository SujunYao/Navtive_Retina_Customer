export default {
  ...
  "dating-dates-state-new-title": "Choose 3 ideal referral periods",
  "dating-dates-state-new-desc": "The hospital staff will choose one of the 3 time periods you selected and confirm with you",
  ...
  "dating-detial-card-time-range-title": "Ideal referral period",
  "dating-detial-card-time-range-title-readonly": "Referral period",
  ...
  "login-phr-vr": "Enter your phone number to register/login",
  "login-phr-phone-num": "Phone number",
  "login-title-has-logged-in-title": "Account Has Logged In",
  "login-title-has-logged-in-desc": "The mobile number ending with *${0} has been logged in on other devices- If verify continues, the source device will be logged out",
  ...
  "home-no-last-exam": "No Examination",
  ...
  "report-lagbel-photo-finds": "Findings",
